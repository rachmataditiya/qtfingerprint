...
BEGIN {
    ...
    require '/Users/rachmataditiya/Projects/uareu/build-android-arm64-v8a/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/rachmataditiya/Projects/uareu/build-android-arm64-v8a/openssl/test/fips-and-base.cnf';
    shift;
